...
public class ActivityDyShiXing extends BaseActivity implements View.OnClickListener {
    ...
    private void initView() {
        ...
        this.holder.shixingCount.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence charSequence, int i, int i2, int i3) {
                try {
                    SPHelper.putInt(ActivityDyShiXing.this.context, ActivityDyShiXing.SP_Key_shixing, Integer.valueOf(charSequence.toString()).intValue());
                } catch (Exception e) {
                }
            }
        });
        this.holder.runSpeed.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence charSequence, int i, int i2, int i3) {
                try {
                    SPHelper.putInt(ActivityDyShiXing.this.context, ActivityDyShiXing.SP_Key_runSpeed, Integer.valueOf(charSequence.toString()).intValue());
                } catch (Exception e) {
                }
            }
        });
        while (true) {
            ...
            if (i < strArr2.length) {
                ...
                ((EditText) this.holder.msgs.get(i)).addTextChangedListener(new TextWatcher() {
                    ...
                    public void onTextChanged(CharSequence charSequence, int i, int i2, int i3) {
                        SPHelper.putString(ActivityDyShiXing.this.context, str, charSequence.toString());
                        Log.v(this.getClass().getSimpleName() + "str", "----------------------------------------------------------");
                        Log.v(this.getClass().getSimpleName() + "str", SPHelper.getString(ActivityDyShiXing.this.context, str, ""));
                        Log.v(this.getClass().getSimpleName() + "str", "----------------------------------------------------------");
                    }
                });
                i++;
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView((int) R.layout.activity_dy_shi_xing);
        initHolder();
        initView();
    }
}
